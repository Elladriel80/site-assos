-- =========================================================================
-- INTER-TOW 2026 — Migration Phase 13 (capacités 16 / 35 / 22)
-- À exécuter UNE FOIS dans : Supabase Dashboard → SQL Editor → New query
--
-- Ouverture / ajustement des places par format, dans le CTE `cap` de
-- get_inscription_stock() (seule source de vérité, réutilisée par
-- create_inscription pour le contrôle de quota) :
--   equipe    : 12 -> 16   (+4 équipes)
--   jeu_libre : 50 -> 35   (-15 places)
--   narratif  : 16 -> 22   (+6 places)
...
AS $function$
  with cap(inscription_type, capacity) as (
    values ('equipe', 16), ('jeu_libre', 35), ('narratif', 22)
  ),
